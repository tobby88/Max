...
namespace Tobby.Max
{
    class HeaterThermostat
    {
        ...
        // constructor:
        public HeaterThermostat(string rfAddress, string serial, string name)
        {
        ...
        // update data of HeaterThermostat
        public void Update(byte unknown, BitArray flags, byte valve, double setTemp, string dateUntil, string timeUntil)
        {
        ...
        public void Update(byte unknown, BitArray flags, byte valve, double setTemp, double actualTemp)
        {
            this.unknown = unknown;
            // todo: flags!
            this.valve = valve;
